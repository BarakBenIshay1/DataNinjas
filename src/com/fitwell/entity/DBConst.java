...
import com.fitwell.control.FileHelper;
...
public final class DBConst {
    ...
    protected static final String DB_FILEPATH = FileHelper.getDataPath(DB_NAME); // "/Volumes/disk1_2/macbkp/"+DB_NAME;
 ...
 // ===== EquipmentType SQL =====
    ...
    public static final String SQL_INS_EQUIPMENT_TYPE =
            "INSERT INTO EquipmentType (equipmentTypeID, name, categoryId, description) VALUES (?, ?, ?, ?)";
